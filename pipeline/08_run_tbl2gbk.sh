...
do
  ...
  funannotate util tbl2gbk -i annotate/$BASE/update_results/$BASE.tbl -f annotate/$BASE/update_results/$BASE.scaffolds.fa -s "Histoplasma capsulatum" --strain $STRAIN --tbl2asn "-l paired-ends" -o annotate/$BASE/update_results/$BASE
done
